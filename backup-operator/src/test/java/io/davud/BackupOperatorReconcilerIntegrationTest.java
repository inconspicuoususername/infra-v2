...
import io.davud.k8.backup.reconciler.BackupOperatorReconciler;
import io.davud.k8.backup.crd.BackupJobSpec;
...
import static io.davud.k8.backup.ConfigMapDependentResource.KEY;
import static org.assertj.core.api.Assertions.assertThat;
import static org.awaitility.Awaitility.await;

class BackupOperatorReconcilerIntegrationTest {
    ...
    LocallyRunOperatorExtension extension =
            LocallyRunOperatorExtension.builder()
                    .withReconciler(BackupOperatorReconciler.class)
                    .build();
    ...
    BackupCRD testResource() {
        var resource = new BackupCRD();
        resource.setMetadata(new ObjectMetaBuilder()
                .withName(RESOURCE_NAME)
                .build());
        resource.setSpec(new BackupJobSpec());
